var xhr= new XMLHttpRequest();
  xhr.open("GET","https://api.nytimes.com/svc/topstories/v2/science.json?api-key=PBVgqcDlMzFfJMaoXrTgPA4zCquaSGbA");
  xhr.send();
  var data;
  xhr.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
       ...
       document.getElementById("news17").innerHTML=data.results[7].abstract;
       document.getElementById("news27").innerHTML=data.results[7].published_date;
       document.getElementById("news37").innerHTML=data.results[7].byline;

       document.getElementById("news08").innerHTML=data.results[8].title;
       document.getElementById("news18").innerHTML=data.results[8].abstract;
       document.getElementById("news28").innerHTML=data.results[8].published_date;
       document.getElementById("news38").innerHTML=data.results[8].byline;

       
       document.getElementById("news09").innerHTML=data.results[9].title;
       document.getElementById("news19").innerHTML=data.results[9].abstract;
       document.getElementById("news29").innerHTML=data.results[9].published_date;
       document.getElementById("news39").innerHTML=data.results[9].byline;
